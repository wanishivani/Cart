...
export function About() {
  return (
    <div  style={{height:'800px',width:'1800px'}}>
      ...
      <h1>About</h1>
      <Card.Img className="rounded-circle"  src="./image/Band Members.png" variant="left"  style ={{height:'200px' , width: '300px'}}>
      </Card.Img>


      <p  className= "text-lg-left"style={{backgroundColor: 'white', fontFamily:"Arial"}}>
