...
export function Home() {
  return (
    <div>
      <h1 style={{ textAlign:"center",padding:'50px',fontSize:'100px',fontFamily:"Arial"}}
        
      >Tour
      </h1>
      <div
        className="d-flex flex-column bd-highlight mb-3  mh-200 h-200  d-flex justfy-content-center mw-400"
        style={{ padding: "50px", margin: "", height: "1140px",textAlign:"center" ,maxWidth:"1000px"}}
      >
        <Row
          style={{
            padding: "90px",
        ...
        >
          <Col style={{ paddingInline: "2px", backgroundColor: "orange" }}>
            <h1>Year</h1>
          </Col>
          <Col style={{ backgroundColor: "yellow" }}>
            <h1>Name</h1>
          </Col>
          <Col style={{ backgroundColor: "powderblue" }}>
            <h1> Concert</h1>
          </Col>
        ...
        >
          <Col style={{ padding: "20px", backgroundColor: "orange" }}>
            JUL16
          </Col>
          <Col style={{ padding: "20px", backgroundColor: "yellow" }}>
            DETROIT, MI
          </Col>
